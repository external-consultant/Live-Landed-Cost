pageextension 50125 PurchaseOrderExt extends "Purchase Order"
{
    Description = 'T47283';
    layout
    {
            ...
            action("Landed Cost Detail")
            {
                ...
                begin
                    if Rec."Completely Received" then begin
                        ...
                        LandedCostDetaillRec.SetRange("Document Type", LandedCostDetaillRec."Document Type"::"Purchase Order");
                    ...
                    if LandedCostDetaillRec.FindFirst() then
                        ...
                        LandedCostMaster_lRec.SetRange("Document Type", LandedCostMaster_lRec."Document Type"::"Purchase Order");
                        if LandedCostMaster_lRec.FindSet() then
                            repeat
                                LineNo_gInt := LineNo_gInt + 10000;
                                LandedCostDetaillRec.Init();
                                LandedCostDetaillRec."Document Type" := LandedCostDetaillRec."Document Type"::"Purchase Order";
